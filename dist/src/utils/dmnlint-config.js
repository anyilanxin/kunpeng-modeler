 ...
 *
 * 本软件 AnYi Process Designer Native Vue EE 商业授权软件。未经过商业授权禁止使用，违者必究。
 *
 * AnYi Process Designer Native Vue EE 为商业授权组件，您在使用过程中，需要注意以下几点：
 *   1.不允许在国家法律法规规定的范围外使用，如出现违法行为作者本人不承担任何责任；
 *   2.软件使用的第三方依赖皆为开源软件，如需要修改第三方依赖请遵循第三方依赖附带的开源协议，因擅自修改第三方依赖所引起的争议，作者不承担任何责任；
 *   3.不得基于AnYi Process Designer Native Vue EE的基础，修改包装而成一个与AnYi Cloud EE、AnYi Kunpeng EE、AnYi Standalone EE功能类似的程序，进行销售或发布，参与同类软件产品市场的竞争；
