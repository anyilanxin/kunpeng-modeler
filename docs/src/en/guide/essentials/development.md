...
```json
{
  "scripts": {
    ...
    "build:antd": "pnpm run build --filter=@kunpeng/web-antd",
    // Build the documentation separately
    "build:docs": "pnpm run build --filter=@kunpeng/docs",
    // Build the web-ele application separately
    "build:ele": "pnpm run build --filter=@kunpeng/web-ele",
    // Build the web-naive application separately
    "build:naive": "pnpm run build --filter=@kunpeng/naive",
    // Build the web-tdesign application separately
    "build:tdesign": "pnpm run build --filter=@kunpeng/web-tdesign",
    // Build the playground application separately
    "build:play": "pnpm run build --filter=@kunpeng/playground",
    ...
    "dev:antd": "pnpm -F @kunpeng/web-antd run dev",
    // Start the documentation
    "dev:docs": "pnpm -F @kunpeng/docs run dev",
    // Start the web-ele application
    "dev:ele": "pnpm -F @kunpeng/web-ele run dev",
    // Start the web-naive application
    "dev:naive": "pnpm -F @kunpeng/web-naive run dev",
    // Start the playground application
    "dev:play": "pnpm -F @kunpeng/playground run dev",
    // Format code
...
Take the addition of the test environment `test` to `@kunpeng/web-antd` as an example:
...
"scripts": {
    ...
    "build:analyze": "turbo build:analyze",
    "build:antd": "pnpm run build --filter=@kunpeng/web-antd",
    "build-test:antd": "pnpm run build --filter=@kunpeng/web-antd build:test",
...
"tasks": {
    ...
    "build-test:antd": {
      "dependsOn": ["@kunpeng/web-antd#build:test"],
      "outputs": ["dist/**"]
    },

    "@kunpeng/web-antd#build:test": {
      "dependsOn": ["^build"],
      "outputs": ["dist/**"]
    },
