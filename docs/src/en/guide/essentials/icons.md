...
- The icons in the project are mainly provided by the `@kunpeng/icons` package. It is recommended to manage them within this package for unified management and maintenance.
...
import { createIconifyIcon } from '@kunpeng-core/icons';
...
import { MdiKeyboardEsc } from '@kunpeng/icons';
</script>
...
```vue
<script setup lang="ts">
import { SvgTestIcon } from '@kunpeng/icons';
</script>
