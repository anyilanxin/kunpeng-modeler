...
To access the variables inside `_app.config.js`, you need to use the `useAppConfig` method provided by `@kunpeng/hooks`.
...
const defaultPreferences: Preferences = {
  app: {
    ...
    contentPaddingTop: 0,
    defaultAvatar:
      'https://unpkg.com/@kunpengjs/static-source@0.1.7/source/avatar-v1.webp',
  ...
  logo: {
    ...
    fit: 'contain',
    source:
      'https://unpkg.com/@kunpengjs/static-source@0.1.7/source/logo-v1.webp',
    // sourceDark: 'https://unpkg.com/@kunpengjs/static-source@0.1.7/source/logo-dark.webp', // Optional: Dark theme logo
  },
  navigation: {
    accordion: true,
    split: true,
