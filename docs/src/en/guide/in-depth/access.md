...
With the permission codes, you can use the `AccessControl` component and API provided by `@kunpeng/access` to show and hide buttons.

#### Component Method

```vue
<script lang="ts" setup>
import { AccessControl, useAccess } from '@kunpeng/access';
...
```vue
<script lang="ts" setup>
import { AccessControl } from '@kunpeng/access';
</script>
...
```vue
<script lang="ts" setup>
import { useAccess } from '@kunpeng/access';
