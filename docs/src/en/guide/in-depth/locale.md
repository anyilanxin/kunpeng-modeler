...
```ts
import type { SupportedLanguagesType } from '@kunpeng/locales';
import { loadLocaleMessages } from '@kunpeng/locales';
import { updatePreferences } from '@kunpeng/preferences';
...
- Do not place business translation texts inside `@kunpeng/locales` to better manage business and general translation texts.
...
With `@kunpeng/locales`, you can easily use translation texts:
