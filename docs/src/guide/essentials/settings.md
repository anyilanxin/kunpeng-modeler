...
想要获取 `_app.config.js` 内的变量，需要使用`@kunpeng/hooks`提供的 `useAppConfig`方法。
...
const defaultPreferences: Preferences = {
  ...
  logo: {
    ...
    // sourceDark: 'https://unpkg.com/@kunpengjs/static-source@0.1.7/source/logo-dark.webp', // 可选：暗色主题logo
  },
  navigation: {
    accordion: true,
    split: true,
