          ...
          patterns: [
            {
              group: ['@kunpeng/*'],
              message:
                'The @core package cannot import the @kunpeng package, please use the @core package itself',
            },
          ],
        },
      ],
          ...
          patterns: [
            {
              group: ['@kunpeng/*'],
              message:
                'The @kunpeng package cannot be imported, please use the @core package itself',
            },
          ],
        },
      ],
