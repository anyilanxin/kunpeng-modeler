...
import { ExpressionPopup } from './components';
...
export class ExpressionPopupRenderer {
  ...
  _renderPopup(context) {
    ...
    render(
      <ExpressionPopup { ...config } eventBus={ this._eventBus } />,
      element
    );
...
ExpressionPopupRenderer.$inject = [ 'eventBus' ];
