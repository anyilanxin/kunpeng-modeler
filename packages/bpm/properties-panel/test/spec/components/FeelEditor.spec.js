...
import FeelComponent from 'src/components/entries/FEEL/ExpressionEditor';

insertCoreStyles();

describe('<ExpressionEditor>', function () {
  let container;
  ...
  it('should update placeholder when changed', async function () {
    // given
    const placeholder = 'foo';
    const component = render(<Wrapper placeholder={placeholder} />, {
      container,
    });
