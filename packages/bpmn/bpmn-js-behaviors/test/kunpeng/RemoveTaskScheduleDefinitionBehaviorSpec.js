...
describe('camunda-cloud/features/modeling - RemoveTaskScheduleBehavior', function() {
  ...
  describe('removing kunpeng:TaskSchedule when dueDate is set to undefined', function() {
  ...
  describe('removing kunpeng:TaskSchedule when followUpDate is set to undefined', function() {
  ...
  describe('removing kunpeng:TaskSchedule when dueDate and followUpDate are set to undefined', function() {
  ...
  describe('NOT removing kunpeng:TaskSchedule', function() {
...
function getTaskSchedule(element) {
  ...
  return getExtensionElementsList(businessObject, 'kunpeng:TaskSchedule')[0];
}
