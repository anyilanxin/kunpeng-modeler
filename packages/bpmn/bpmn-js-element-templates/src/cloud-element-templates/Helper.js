 ...
 * @type {String}
 */
export const TEMPLATE_ID_ATTR = 'kunpeng:modelerTemplate';
 ...
 * @type {String}
 */
export const TEMPLATE_VERSION_ATTR = 'kunpeng:modelerTemplateVersion';
 ...
 * @type {String}
 */
export const TEMPLATE_ICON_ATTR = 'kunpeng:modelerTemplateIcon';
...
export function findKunpengProperty(zeebeProperties, binding) {
...
export function findTaskHeader(additionDynamics, binding) {
...
export function findKunpengSubscription(message) {
  return findExtension(message, 'kunpeng:Subscription');
}
