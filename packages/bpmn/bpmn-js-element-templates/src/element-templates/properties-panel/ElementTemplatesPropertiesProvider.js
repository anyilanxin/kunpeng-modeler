import { ListGroup } from '@kunpeng/properties-panel';

import { createElementTemplatesGroup, TemplateProps } from '../../components';
...
export default class ElementTemplatesPropertiesProvider {
  ...
  _shouldShowTemplateProperties(element) {
    return (
      getTemplateId(element) || this._elementTemplates.getAll(element).length
    );
  }
}
