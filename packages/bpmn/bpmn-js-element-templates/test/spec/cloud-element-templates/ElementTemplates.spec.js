...
describe('provider/cloud-element-templates - ElementTemplates', function() {
  ...
  describe('createElement', function() {
    ...
    it('should create element with kunpeng:UserTask', inject(function(elementTemplates) {
  ...
  describe('applyTemplate', function() {
    ...
    it('should only have 1 task definition', inject(function(elementRegistry, elementTemplates) {
      ...
      const taskDefinitions = findExtensions(updatedTask, [ 'kunpeng:TaskDefinition' ]);
    ...
    it('should apply message kunpeng:subscription binding', inject(function(elementRegistry, elementTemplates) {
    ...
    it('should apply kunpeng:userTask binding', inject(function(elementRegistry, elementTemplates) {
      ...
      // then
      const userTask = findExtension(updatedTask, 'kunpeng:UserTask');
      expect(userTask).to.exist;
    }));


    it('should not create <kunpeng:UserTask> if it exists', inject(function(elementRegistry, elementTemplates) {
      ...
      // assume
      const userTask = findExtension(task, 'kunpeng:UserTask');
      expect(userTask).to.exist;
      ...
      // then
      const updatedUserTask = findExtensions(updatedTask, [ 'kunpeng:UserTask' ]);
      expect(updatedUserTask).to.have.length(1);
    }));


    it('should not create <kunpeng:UserTask> if template has no binding', inject(function(elementRegistry, elementTemplates) {
      ...
      // then
      const updatedUserTask = findExtension(task, 'kunpeng:UserTask');
      expect(updatedUserTask).to.not.exist;
    }));


    it('should remove <kunpeng:UserTask> if new template has no binding', inject(function(elementRegistry, elementTemplates) {
      ...
      // assume
      expect(findExtension(task, 'kunpeng:UserTask')).to.exist;

      // when
      const updatedTask = elementTemplates.applyTemplate(task, templates[1]);

      // then
      const updatedUserTask = findExtension(updatedTask, 'kunpeng:UserTask');
      expect(updatedUserTask).to.not.exist;
    }));
  ...
  describe('unlinkTemplate', function() {
    ...
    it('should remove template icon', inject(function(elementRegistry, elementTemplates) {
      ...
      expect(getBusinessObject(task).get('kunpeng:modelerTemplateIcon')).to.not.exist;
    }));
  ...
  describe('removeTemplate', function() {
    ...
    it('should keep execution listeners', inject(function(elementRegistry, elementTemplates) {
      ...
      // then
      const bo = getBusinessObject(task);
      expect(bo.extensionElements.values[0].$type).to.equal('kunpeng:ExecutionListeners');
    }));
