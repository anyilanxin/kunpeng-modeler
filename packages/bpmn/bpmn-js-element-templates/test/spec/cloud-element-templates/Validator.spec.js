...
import { getZeebeSchemaVersion as getTemplateSchemaVersion } from '@kunpeng/element-templates-validator';
...
describe('provider/cloud-element-templates - Validator', function() {
  ...
  describe('content validation', function() {
    ...
    it('should reject invalid optional binding type', function() {
      ...
      // then
      expect(errors(templates)).to.contain('template(id: <invalid>, name: <Invalid>): optional is not supported for binding type "property"; must be any of { kunpeng:input, kunpeng:output, kunpeng:property, kunpeng:taskHeader }');
