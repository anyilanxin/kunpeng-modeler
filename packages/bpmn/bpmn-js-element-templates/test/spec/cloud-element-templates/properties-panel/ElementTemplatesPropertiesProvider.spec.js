...
describe('provider/cloud-element-templates - ElementTemplatesPropertiesProvider', function() {
  ...
  describe('conditional entries', function() {
    ...
    describe('condition on boolean field', function() {
      ...
      it('should show if condition is met on kunpeng:property (true)', inject(async function(elementRegistry, selection) {
      ...
      it('should show if condition is met on kunpeng:property (false)', inject(async function(elementRegistry, selection) {
