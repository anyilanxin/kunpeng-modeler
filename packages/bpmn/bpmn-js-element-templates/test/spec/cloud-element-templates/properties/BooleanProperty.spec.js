...
describe('provider/cloud-element-templates - BooleanProperty', function() {
  ...
  describe('no feel property - static for kunpeng:input and kunpeng:output', function() {
    ...
    it('should cast to FEEL expression as in static (kunpeng:input)', async function() {
    ...
    it('should cast to FEEL expression as in static (kunpeng:output)', async function() {
