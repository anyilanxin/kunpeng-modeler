...
describe('provider/cloud-element-templates - CustomProperties - binding type property', function() {
  ...
  describe('calledDecision', function() {
    ...
    it('should change, setting bindingType', inject(async function(elementTemplates) {
      ...
      const calledDecision = findExtension(getBusinessObject(element), 'kunpeng:CalledDecision');
  ...
  describe('calledElement', function() {
    ...
    it('should change, setting bindingType', inject(async function(elementTemplates) {
      ...
      const calledElement = findExtension(getBusinessObject(element), 'kunpeng:CalledElement');
  ...
  describe('linkedResource', function() {
    ...
    it('should change, setting bindingType', inject(async function(elementTemplates) {
      ...
      // then
      expect(select.value).to.equal('latest');
      const linkedResources = findExtension(getBusinessObject(element), 'kunpeng:LinkedResources');
  ...
  describe('formDefinition', function() {
    ...
    it('should change, setting bindingType', inject(async function(elementTemplates) {
      ...
      // then
      expect(select.value).to.equal('latest');
      const formDefinition = findExtension(getBusinessObject(element), 'kunpeng:FormDefinition');
