...
function BusinessRuleImplementation(props) {
  ...
  /**
   * Set value by either creating a kunpeng:calledDecision or a kunpeng:taskDefintion
  ...
  const setValue = (value) => {
    ...
    if (value === DMN_IMPLEMENTATION_OPTION) {
      ...
      extensionElementType = 'kunpeng:CalledDecision';
...
function updateExtensionElements(element, extensionElementToAdd, bpmnFactory, commandStack) {
  ...
  } else if (is(extensionElementToAdd, 'kunpeng:CalledDecision')) {
