...
const FormDefinitionBinding = withProps(Binding, { type: 'kunpeng:FormDefinition' }),
      FormDefinitionVersionTag = withProps(VersionTag, { type: 'kunpeng:FormDefinition' });
...
export function FormProps(props) {
  ...
  if (formType === FORM_TYPES.KUNPENG_FORM_EMBEDDED) {
    entries.push({
      id: 'formConfiguration',
      component: FormConfiguration,
      isEdited: isTextAreaEntryEdited
    });
  } else if (formType === FORM_TYPES.KUNPENG_FORM_LINKED) {
    entries.push({
      id: 'formId',
      component: FormId,
  ...
  if (formType === FORM_TYPES.KUNPENG_FORM_LINKED) {
    entries.push({
      id: 'bindingType',
    ...
    if (getBindingType(element, 'kunpeng:FormDefinition') === 'versionTag') {
      entries.push({
        id: 'versionTag',
...
function setFormType(injector, element, value) {
  if (value === FORM_TYPES.KUNPENG_FORM_EMBEDDED) {
    setUserTaskForm(injector, element, '');
  } else if (value === FORM_TYPES.KUNPENG_FORM_LINKED) {
...
function getFormTypeOptions(translate, element) {
  if (isKunpengUserTask(element)) {
    return [
      { value: NONE_VALUE, label: translate('<none>') },
      { value: FORM_TYPES.KUNPENG_FORM_LINKED, label: translate('Kunpeng Form') },
  ...
  return [
    { value: NONE_VALUE, label: translate('<none>') },
    { value: FORM_TYPES.KUNPENG_FORM_LINKED, label: translate('Kunpeng Form (linked)') },
    { value: FORM_TYPES.KUNPENG_FORM_EMBEDDED, label: translate('Kunpeng Form (embedded)') },
