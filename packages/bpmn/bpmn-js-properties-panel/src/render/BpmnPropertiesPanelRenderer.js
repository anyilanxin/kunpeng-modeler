...
/**
 * @typedef { import('@kunpeng/properties-panel').GroupDefinition } GroupDefinition
 * @typedef { import('@kunpeng/properties-panel').ListGroupDefinition } ListGroupDefinition
