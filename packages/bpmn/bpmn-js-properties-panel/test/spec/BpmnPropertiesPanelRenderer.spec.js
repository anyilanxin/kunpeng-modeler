...
} from '@kunpeng/variable-resolver';

import KunpengBehaviorsModule from '@kunpeng/bpmn-js-behaviors';
...
import KunpengTooltipProvider from 'src/contextProvider/TooltipProvider';
  ...
  (singleStart === 'cloud' ? it.only : it)('should import simple process (cloud)', async function() {
    ...
    const result = await createModeler(
      diagramXml,
      {
        ...
        tooltip: KunpengTooltipProvider
      }
    );
