...
import { Header } from '@kunpeng/properties-panel';
...
describe('<PanelHeaderProvider>', function() {
  ...
  describe('#getElementIcon', function() {
    ...
    it('should get template icon - data URI', function() {
      ...
      // given
      const element = createElement('bpmn:Task', {
        'kunpeng:modelerTemplateIcon': "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' height='100' width='100'%3E%3Ccircle cx='50' cy='50' r='40' stroke='black' stroke-width='3' fill='red' /%3E%3C/svg%3E"
      });
      ...
      expect(templateIconNode.src).to.eql(element.businessObject.get('kunpeng:modelerTemplateIcon'));
    });
    ...
    it('should get template icon - https URI', function() {
      ...
      // given
      const element = createElement('bpmn:Task', {
        'kunpeng:modelerTemplateIcon': 'https://camunda.com/wp-content/uploads/2020/05/logo-camunda-black.svg'
      });
