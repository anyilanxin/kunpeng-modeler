...
describe('provider/kunpeng - BusinessRuleImplementationProps', function() {
  ...
  describe('bpmn:BusinessRuleTask#implementation', function() {
    ...
    it('should remove taskDefinition and additionDynamics when set to none', inject(
      async function(elementRegistry, selection) {
        ...
        const additionDynamics = getAdditionDynamics(businessRuleTask);
    ...
    describe('integration', function() {
      ...
      it('should remove task definition and task headers when adding called decision', inject(async function(elementRegistry, selection) {
        ...
        expect(getAdditionDynamics(businessRuleTask)).to.exist;
        ...
        expect(getAdditionDynamics(businessRuleTask)).not.to.exist;
