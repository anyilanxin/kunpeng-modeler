...
import kunpengModdleExtensions from '@kunpeng/bpmn-moddle/resources/kunpeng.json';

import diagramXML from './ExecutionListenerProps.bpmn';
import { getExtensionElementsList } from 'src/utils/ExtensionElementsUtil';


describe('provider/kunpeng - ExecutionListenerProps', function() {
...
function getListeners(element) {
  ...
  const executionListeners = getExtensionElementsList(bo.get('processRef') || bo, 'kunpeng:ExecutionListeners')[0];
