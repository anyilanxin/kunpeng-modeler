...
import { getExtensionElementsList } from 'src/utils/ExtensionElementsUtil.js';
...
import {
  ...
  getRootElement,
  getUserTaskForm,
} from 'src/provider/kunpeng/utils/FormUtil.js';
...
describe('provider/kunpeng - Forms', function() {
  const testModules = [
    BpmnPropertiesPanel,
    CoreModule,
    ModelingModule,
  ...
  describe('form type', function() {
    it('should display - embedded form', inject(async function(
        elementRegistry,
        selection,
    ) {
    ...
    it('should display - linked form', inject(async function(
        elementRegistry,
        selection,
    ) {
    ...
    it('should display - custom form', inject(async function(
        elementRegistry,
        selection,
    ) {
    ...
    it('should display - external reference', inject(async function(
        elementRegistry,
        selection,
    ) {

      // given
      const userTask = elementRegistry.get('CUSTOM_FORM_KUNPENG_USER_TASK');
    ...
    it('should display - empty', inject(async function(
        elementRegistry,
        selection,
    ) {
    ...
    it('should update - empty', inject(async function(
        elementRegistry,
        selection,
    ) {
    ...
    it('should update - embedded form', inject(async function(
        elementRegistry,
        selection,
    ) {
    ...
    it('should update - linked form', inject(async function(
        elementRegistry,
        selection,
    ) {
    ...
    it('should update - custom form', inject(async function(
        elementRegistry,
        selection,
    ) {
    ...
    it('should update - external reference', inject(async function(
        elementRegistry,
        selection,
    ) {

      // given
      const userTask = elementRegistry.get('NO_FORM_KUNPENG_USER_TASK');
    ...
    it('should update on external change', inject(async function(
      ...
      const formTypeSelect = getFormTypeSelect(container);
      const initialTaskForms = getExtensionElementsList(
        rootElement,
        'kunpeng:UserTaskForm',
      ).length;
      ...
      const forms = getExtensionElementsList(
        rootElement,
        'kunpeng:UserTaskForm',
      );
  ...
  describe('embedded form', function() {
    ...
    it('should not delete if empty', inject(async function(
        elementRegistry,
        selection,
    ) {
  ...
  describe('linked form', function() {
    ...
    it('should display - Zeebe User Task', inject(async function(
        elementRegistry,
        selection,
    ) {

      // given
      const userTask = elementRegistry.get(
        'CAMUNDA_FORM_LINKED_KUNPENG_USER_TASK',
      );
  ...
  describe('custom form', function() {
    ...
    it('should NOT display', inject(async function(
        elementRegistry,
        selection,
    ) {
