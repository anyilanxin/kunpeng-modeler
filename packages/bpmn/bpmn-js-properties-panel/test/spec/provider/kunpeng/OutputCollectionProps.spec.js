...
import TooltipProvider from 'src/contextProvider/TooltipProvider';
...
describe('provider/kunpeng - OutputCollection', function() {
  ...
  describe('#outputCollection', function() {
    ...
    it('should create kunpeng:adHoc extension element if it does not exist', inject(async function(
        elementRegistry, selection
    ) {
...
/**
 * getZeebeAdHocExtension - get the kunpeng:adHoc extension element.
 *
 * @param {djs.model.Base} element
 *
 * @return {ModdleElement<kunpeng:AdHoc>} the kunpeng:adHoc extension element
 */
function getZeebeAdHocExtension(element) {
  const businessObject = getBusinessObject(element);
  const extensions = getExtensionElementsList(businessObject, 'kunpeng:AdHoc');
  return extensions[0];
}
