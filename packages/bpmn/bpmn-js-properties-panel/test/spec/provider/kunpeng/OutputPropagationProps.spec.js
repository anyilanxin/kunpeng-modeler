...
} from 'src/provider/kunpeng/utils/CalledElementUtil.js';

import {
  getIoMapping
} from 'src/provider/kunpeng/utils/InputOutputUtil.js';
...
describe('provider/kunpeng - OutputPropagationProps', function() {
  ...
  describe('bpmn:CallActivity#calledElement.propagateAllChildVariables', function() {
    ...
    it('should re-use extensionElements', inject(async function(elementRegistry, selection) {
      ...
      // assume
      expect(getExtensionElementsList(businessObject, 'kunpeng:IoMapping')).to.have.length(1);
      ...
      // then
      const ioMapping = getExtensionElementsList(businessObject, 'kunpeng:IoMapping');
    ...
    describe('integration', function() {
      ...
      describe('set kunpeng:propagateAllChildVariables to false', function() {
