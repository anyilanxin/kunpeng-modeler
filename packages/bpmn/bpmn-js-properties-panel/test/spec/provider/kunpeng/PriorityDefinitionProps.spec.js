...
import { getPriorityDefinition } from 'src/provider/kunpeng/properties/PriorityDefinitionProps';
...
describe('provider/kunpeng - PriorityDefinitionProps', function() {
  ...
  describe('kunpeng:priorityDefinition', function() {
    ...
    it('should NOT display for user task without kunpeng:UserTask', inject(async function(elementRegistry, selection) {
    ...
    it('should create priority definition',
      inject(async function(elementRegistry, selection) {
        ...
        // assume
        expect(getExtensionElementsList(getBusinessObject(userTask), 'kunpeng:priorityDefinition')).to.be.empty;
        ...
        // then
        const priorityDefinitionElement = getExtensionElementsList(getBusinessObject(userTask), 'kunpeng:PriorityDefinition')[0];
  ...
  describe('integration', function() {
    ...
    describe('removing priority definition when empty', function() {
      ...
      it('removing kunpeng:priority', inject(async function(elementRegistry, selection) {
