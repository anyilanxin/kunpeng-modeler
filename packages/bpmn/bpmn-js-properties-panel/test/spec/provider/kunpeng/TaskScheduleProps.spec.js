...
import { getTaskSchedule } from 'src/provider/kunpeng/properties/TaskScheduleProps';
...
describe('provider/kunpeng - TaskScheduleProps', function() {
  ...
  describe('kunpeng:dueDate', function() {
  ...
  describe('kunpeng:followUpDate', function() {
  ...
  describe('integration', function() {
    ...
    describe('removing task schedule when empty', function() {
      ...
      it('removing kunpeng:dueDate', inject(async function(elementRegistry, selection) {
      ...
      it('removing kunpeng:followUpDate', inject(async function(elementRegistry, selection) {
