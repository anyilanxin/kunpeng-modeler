...
describe('provider/kunpeng - UserTaskImplementationProps', function() {
  ...
  describe('bpmn:UserTask#implementation', function() {
    ...
    it('should create kunpeng:UserTask', inject(async function(elementRegistry, selection) {
    ...
    it('should remove kunpeng:UserTask when set to jobWorker', inject(
...
function getZeebeUserTask(element) {
  ...
  return getExtensionElementsList(businessObject, 'kunpeng:UserTask')[0];
}
