...
import kunpengModdleExtension from '@kunpeng/bpmn-moddle/resources/kunpeng.json';

import diagramKunpengXML from './ExtensionPropertiesProps.kunpeng.bpmn';
...
describe('provider/shared - ExtensionPropertiesProps', function() {
  ...
  function getDiagram() {
    return diagramKunpengXML;
  }

  function getOptions() {
    return {
      modules: [ ...testModules, KunpengPropertiesProvider ],
      moddleExtensions: { kunpeng: kunpengModdleExtension }
    };
  }
