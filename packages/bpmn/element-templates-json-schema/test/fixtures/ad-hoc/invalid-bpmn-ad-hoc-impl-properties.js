export const template = {
  ...
  'properties': [
    ...
    {
      'type': 'Hidden',
      'binding': { 'type': 'kunpeng:adHoc', 'property': 'activeElementsCollection' },
...
export const errors = [
  {
    ...
    message: 'Property "cancelRemainingInstances" must not be set when using a "kunpeng:taskDefinition" implementation for a "bpmn:AdHocSubProcess"'
  },
  {
    keyword: 'errorMessage',
    ...
    message: 'Property "completionCondition" must not be set when using a "kunpeng:taskDefinition" implementation for a "bpmn:AdHocSubProcess"'
  },
  {
    keyword: 'errorMessage',
    ...
    message: 'Property "activeElementsCollection" must not be set when using a "kunpeng:taskDefinition" implementation for a "bpmn:AdHocSubProcess"'
  },
  {
    keyword: 'if',
    dataPath: '',
