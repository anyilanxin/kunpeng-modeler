export const template = {
  ...
  'name': 'AdHoc Missing Output Element Feel',
  'id': 'io.camunda.examples.AdHoc.MissingOutputElementFeel',
  'version': 1,
  ...
  'properties': [
    ...
    {
      'type': 'String',
      'binding': { 'type': 'kunpeng:adHoc', 'property': 'outputElement' },
