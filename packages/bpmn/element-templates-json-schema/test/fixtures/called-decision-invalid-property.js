...
export const errors = [
  {
    ...
    message: 'Binding type "kunpeng:calledDecision" must contain property "decisionId"',
  },
  {
    keyword: 'contains',
    dataPath: '/properties',
  ...
  },
  {
    ...
    message: 'Binding type "kunpeng:calledDecision" must contain property "resultVariable"',
  },
  {
    keyword: 'contains',
    dataPath: '/properties',
