...
- `FEAT`: support `kunpeng:calledElement` variables propagation properties ([camunda/element-templates-json-schema#210](https://github.com/camunda/element-templates-json-schema/pull/210))
...
- `FEAT`: support `activeElementsCollection` property on `kunpeng:adHoc` ([camunda/element-templates-json-schema#198](https://github.com/camunda/element-templates-json-schema/pull/198))
- `DEPS`: update to `@camunda/zeebe-element-templates-json-schema@0.31.1`

# 2.12.0

- `FEAT`: support `kunpeng:taskSchedule` binding ([#66](https://github.com/bpmn-io/element-templates-validator/pull/66))
- `FEAT`: disallow `bpmn:cancelRemainingInstances`, `bpmn:completionCondition` and `kunpeng:activeElementsCollection` when `kunpeng:taskDefinition` present ([camunda/element-templates-json-schema#194](https://github.com/camunda/element-templates-json-schema/pull/194))
- `DEPS`: update to `@camunda/zeebe-element-templates-json-schema@0.30.0`

## 2.11.0

- `FEAT`: support `kunpeng:adHoc` binding ([#67](https://github.com/bpmn-io/element-templates-validator/pull/67))
- `DEPS`: update to `@camunda/zeebe-element-templates-json-schema@0.29.0`

## 2.10.0

- `FEAT`: support `kunpeng:priorityDefinition` binding ([#64](https://github.com/bpmn-io/element-templates-validator/pull/64))
- `DEPS`: update to `@camunda/zeebe-element-templates-json-schema@0.28.0`

## 2.9.0

- `FEAT`: support `kunpeng:assignmentDefinition` binding ([#63](https://github.com/bpmn-io/element-templates-validator/pull/63))
- `DEPS`: update to `@camunda/zeebe-element-templates-json-schema@0.27.0`

## 2.8.0

- `FEAT`: `validateKunpeng`, and `validate` support JSON strings preserving the original format ([#58](https://github.com/bpmn-io/element-templates-validator/issues/58))
...
- `FEAT`: support `kunpeng:formDefinition` ([#56](https://github.com/bpmn-io/element-templates-validator/pull/56))
- `FEAT`: support `kunpeng:calledDecision` ([#56](https://github.com/bpmn-io/element-templates-validator/pull/56))
- `FEAT`: support `bpmn:ScriptTask` with `kunpeng:script` and `kunpeng:taskDefinition` ([#56](https://github.com/bpmn-io/element-templates-validator/pull/56))
- `DEPS`: update to `@camunda/zeebe-element-templates-json-schema@0.24.0`

## 2.4.0

- `FEAT`: support `kunpeng:userTask` property for zeebe templates ([camunda/element-templates-json-schema#162](https://github.com/camunda/element-templates-json-schema/pull/162))
...
- `FIX`: make `feel=static` the default but value for `kunpeng:input` and `kunpeng:output` properties ([camunda/element-templates-json-schema#157](https://github.com/camunda/element-templates-json-schema/pull/157))
...
- `FEAT`: support `kunpeng:calledElement` templating
- `DEPS`: update to `@camunda/zeebe-element-templates-json-schema@0.17.0`

## 1.6.1

- `FIX`: remove `kunpeng:subscription` templating for send task
...
- `FEAT`: add `kunpeng:taskDefinition` binding ([camunda/element-templates-json-schema#117](https://github.com/camunda/element-templates-json-schema/pull/117))
- `FEAT`: mark `kunpeng:taskDefinition:type` as deprecated ([camunda/element-templates-json-schema#117](https://github.com/camunda/element-templates-json-schema/pull/117))
- `FEAT`: remove `kunpeng:taskDefinition:retries` binding ([camunda/element-templates-json-schema#117](https://github.com/camunda/element-templates-json-schema/pull/117))
...
- `FEAT`: support `optional` for `kunpeng:taskHeader` binding ([element-templates-json-schema#87](https://github.com/camunda/element-templates-json-schema/pull/87))
...
- `FEAT`: add `validateKunpeng`, `validateKunpengAll` and `getKunpengSchemaVersion` ([#6](https://github.com/bpmn-io/element-templates-validator/pull/6))
- `FEAT`: add `getSchemaPackage` and `getKunpengSchemaPackage` ([`52413fe2`](https://github.com/bpmn-io/element-templates-validator/pull/6/commits/52413fe204db60a8954d1af35baef072451b2e08))
