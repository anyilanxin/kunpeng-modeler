...
describe('Validator', function() {
  ...
  describe('#getKunpengSchemaPackage', function() {

    it('should return schema package', function() {

      // then
      expect(getKunpengSchemaPackage()).to.eql(
        require('@camunda/zeebe-element-templates-json-schema/package.json').name);
    });
  });


  describe('#getKunpengSchemaVersion', function() {

    it('should return schema version', function() {

      // then
      expect(getKunpengSchemaVersion()).to.eql(
        require('@camunda/zeebe-element-templates-json-schema/package.json').version);
    });
  });


  describe('#validateKunpeng', function() {
    ...
    it('should retrieve errors', function() {
      ...
      expect(normalizedErrors).to.eql([
        ...
        {
          message: 'property.binding "kunpeng:property" requires name'
        },
        {
  ...
  describe('#validateAllKunpeng', function() {
    ...
    it('should validate kunpeng:adHoc', function() {
    ...
    it('should validate kunpeng:adHoc with errors', function() {
