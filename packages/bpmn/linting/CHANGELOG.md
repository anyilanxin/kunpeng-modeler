...
- `FIX`: ignore non-FEEL properties in `feel` rule ([camunda/bpmnlint-plugin-camunda-compat#231](https://github.com/camunda/bpmnlint-plugin-camunda-compat/pull/231))
...
- `FEAT`: support Conditional Events in Camunda 8.9 or newer ([camunda/bpmnlint-plugin-camunda-compat#224](https://github.com/camunda/bpmnlint-plugin-camunda-compat/pull/224), [#150](https://github.com/camunda/linting/pull/150))
...
- `DEPS`: update to `bpmnlint-plugin-camunda-compat@2.47.0`
...
- `DEPS`: update to `bpmnlint-plugin-camunda-compat@2.44.0`
...
- `FEAT`: add `io-mapping` rule, including error mapping ([#143](https://github.com/camunda/linting/pull/143),[camunda/bpmnlint-plugin-camunda-compat#207](https://github.com/camunda/bpmnlint-plugin-camunda-compat/pull/207))
- `FEAT`: include [`start-event-required`](https://github.com/bpmn-io/bpmnlint/blob/main/docs/rules/start-event-required.md) rule ([camunda/bpmnlint-plugin-camunda-compat#210](https://github.com/camunda/bpmnlint-plugin-camunda-compat/pull/210))
- `FEAT`: add documentation link for `no-loop` rule ([camunda/bpmnlint-plugin-camunda-compat#208](https://github.com/camunda/bpmnlint-plugin-camunda-compat/pull/208))
- `FIX`: use stable camunda-docs version for reference links ([camunda/bpmnlint-plugin-camunda-compat#209](https://github.com/camunda/bpmnlint-plugin-camunda-compat/pull/209))
- `DEPS`: update to `bpmnlint-plugin-camunda-compat@2.39.0`
...
- `DEPS`: update to `bpmnlint-plugin-camunda-compat@2.33.1`
...
`FEAT`: handle `wait-for-completion` rule ([#103](https://github.com/camunda/linting/pull/103)) `DEPS`: update to `bpmnlint-plugin-camunda-compat@2.18.0`

## 3.17.0

`FEAT`: handle `no-zeebe-user-task` rule ([#101](https://github.com/camunda/linting/pull/101)) `FEAT`: handle missing form property for Zeebe User Task ([#101](https://github.com/camunda/linting/pull/101)) `DEPS`: update to `bpmnlint-plugin-camunda-compat@2.17.0` `DEPS`: update to `bpmn-js-properties-panel@5.13.0` `DEPS`: update to `camunda-bpmn-js-behaviors@1.3.0` `DEPS`: update to `zeebe-bpmn-moddle@1.1.0`
...
- `FEAT`: add inclusive-gateway rule ([#44](https://github.com/camunda/bpmnlint-plugin-camunda-compat/pull/44)) propertiesPanel.showEntry
