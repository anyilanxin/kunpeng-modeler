...
import { getPackages } from '@kunpeng/node-utils';
...
const DEFAULT_CONFIG = {
  ...
  ignoreMatches: [
    ...
    '@kunpeng/tsconfig',
    '@kunpeng/vite-config',
    '@kunpeng/tailwind-config',
    '@types/*',
    '@kunpeng-core/design',
  ],
  // 需要忽略的包
  ignorePackages: [
    '@kunpeng/backend-mock',
    '@kunpeng/commitlint-config',
    '@kunpeng/eslint-config',
    '@kunpeng/node-utils',
    '@kunpeng/prettier-config',
    '@kunpeng/stylelint-config',
    '@kunpeng/tailwind-config',
    '@kunpeng/tsconfig',
    '@kunpeng/vite-config',
    '@kunpeng/vsh',
